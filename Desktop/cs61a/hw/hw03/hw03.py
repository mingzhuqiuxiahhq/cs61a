...
#            zero = 0
#            else:
#                with_i = count(total, i ** (+inc))
#                without_i = count(total-i, i)
#                zero = zero + 1
#                inc += 1
...
#        #mirrior the structure from count_p
#        if total == 0:
#            return 1
#        elif total < 0:
#            return 0
...
#    def big_coin(total,power=0):
#        #return biggest coin
#        i= 2
#        max_coin = i**power
#        if total - max_coin <max_coin:
#            return max_coin
#        else:
#            return big_coin(total,power+1)
#    return change_helper(total, big_coin(total))
    ...
    def big_coin(i):
        ...
        if total <max_coin:
            ...
            return big_coin(i*2)
    return change_helper(total, big_coin(1))
#
#
...
#            pass
#        else:
#            return helper(total - small_coin*2, small_coin) + helper(total, small_coin*2)
#
